	...
	links: [
		...
		},
		{
			...
			children: [
				{
					name: "QQ群",
					url: "https://qm.qq.com/q/9ROwtO7nq0",
					external: true,
					icon: "fa6-brands:qq",
				},
				{
					name: "TG群",
					url: "https://t.me/cxyls",
					external: true,
...
export const profileConfig: ProfileConfig = {
	...
	umami: {
		...
		shareId: "aElskaSbLeyyTQGw", //填入共享URL最后面那一串  比如：https://eu.umami.is/api/share/2dKQ5T0WrUn6AYtr 你就填入2dKQ5T0WrUn6AYtr
